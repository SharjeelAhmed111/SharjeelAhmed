...
if(isset($_POST['submit']))
 {
    ...
    $sql="INSERT INTO `products`( `product_Name`, `product_Description`, `product_price`, `C_ID`,`productimage`) VALUES ('$productname','$productdescription','$productprice','$id','$folder')";
...
<form method="POST" action="" enctype="multipart/form-data">
  ...
  <div class="submit">
   ...
   <td><a href='edit.php?id=".$row['product_id']."'><i class='fa-solid fa-pen-to-square'></i> </a> /
    <a href='delete.php?id=".$row['product_id']."'><i class='fa-solid fa-trash'></i></a>
                             </td>
