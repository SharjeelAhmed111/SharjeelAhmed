        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-12 grid-margin">
              <div class="d-flex justify-content-between align-items-center">
                <div>
                  <h4 class="font-weight-bold mb-0">BIZEAL Dashboard</h4>
                </div>
          ...
          <div class="row">
            <div class="col-md-3 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <p class="card-title text-md-center text-xl-left  text-danger">Total User</p>
            ...
            <div class="col-md-3 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <p class="card-title text-md-center text-xl-left  text-danger">Total earnings</p>
                  <div class="d-flex flex-wrap justify-content-between justify-content-md-center justify-content-xl-between align-items-center">
            ...
            <div class="col-md-3 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <p class="card-title text-md-center text-xl-left  text-danger">Total Store</p>
                  <div class="d-flex flex-wrap justify-content-between justify-content-md-center justify-content-xl-between align-items-center">
                    <h3 class="mb-0 mb-md-2 mb-xl-0 order-md-1 order-xl-0">016</h3>
            ...
            <div class="col-md-3 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <p class="card-title text-md-center text-xl-left  text-danger">Total Products</p>
                  <div class="d-flex flex-wrap justify-content-between justify-content-md-center justify-content-xl-between align-items-center">
                    <h3 class="mb-0 mb-md-2 mb-xl-0 order-md-1 order-xl-0">008</h3>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <p class="card-title mb-3">Latest s product Buying</p>
              ...
              <table class="table align-middle mb-0 bg-white">
                ...
                <tbody>
                  <tr>
                    <td>
                      <div class="d-flex align-items-center">
                        ...
                        <div class="ms-3">
                          <p class="fw-bold mb-1">#3245</p>
                          
                        </div>
                      </div>
                    </td>
                    <td>
                      <p class="fw-normal mb-1">User 1</p>
                      
                    </td>
                    <td>
                      <span class="badge badge-success rounded-pill d-inline fs-6 text text-dark">005</span>
                    </td>
                    <td>Credit Card</td>
                    <td> <span> 2022-06-22 </span> </td>
                    <td>
                      <h6><span class="badge bg-success">Comfirm</span></h6>
                    </td>

                    <td> <a class="btn "  href="#!" role="button">
                       <span style="color:white;font-weight: bold;" class="text-danger"> View</span>
                    </a> </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td> <span> 2022-06-22 </span> </td>
                    <td>
                      <h6><span class="badge bg-warning">Cansel</span></h6>
                    </td>
          ...
          <div class="row mt-2 mt-md-5">
                  ...
                  <div class="table-responsive">
                    <table class="table table-hover">
                      ...
                      <tbody>
                        <tr>
                          <td>#001</td>
                          <td>Juicy Fruits Cake</td>
                          <td class="text-success"> 28.76% <i class="ti-arrow-up"></i></td>
                          <td><label class="badge bg-success">In progress</label></td>
                        </tr>
                        <tr>
                          <td>#007</td>
                          <td>Crunchy And Juicy Fruit Cake</td>
                          <td class="text-success"> 21.06% <i class="ti-arrow-up"></i></td>
                          <td><label class="badge bg-success">In progress</label></td>
                        </tr>
                        <tr>
                          <td>#005</td>
                          <td>Kiwi Melonge Cake</td>
                          <td class="text-danger"> 10.00% <i class="ti-arrow-down"></i></td>
                          <td><label class="badge bg-success">In progress</label></td>
                        </tr>
                        <tr>
                          <td>#010</td>
                          <td>Fruit Desire Pineapple Cake</td>
                          <td class="text-success"> 82.00% <i class="ti-arrow-up"></i></td>
                          <td><label class="badge bg-success">In progress</label></td>
                        </tr>
                        <tr>
                          <td>#009</td>
                          <td>Tempting Fruit Cake</td>
                          <td class="text-success"> 98.05% <i class="ti-arrow-up"></i></td>
                          <td><label class="badge bg-success">In progress</label></td>
                        </tr>
                        <tr>
                          <td>#002</td>
                          <td>Chocolate Fruits Cake</td>
            ...
            <div class="col-md-5 grid-margin stretch-card">
                  ...
                  <div class="add-items d-flex mb-0 mt-4">
										...
										<button class="add btn btn-icon text-danger todo-list-add-btn bg-transparent"><i class="ti-location-arrow"></i></button>
									</div>
								</div>
							</div>
            </div>
